...
SOURCEFILES_QUOTED_IF_SPACED=testavr.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/testavr.o
POSSIBLE_DEPFILES=${OBJECTDIR}/testavr.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/testavr.o

# Source Files
SOURCEFILES=testavr.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/testavr.o: testavr.c  .generated_files/flags/default/40019543eb574c033b2a5e4db1683a19b509860c .generated_files/flags/default/2ebadb7499da65fc4c278afdfab593bf9d1d26cd
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/testavr.o.d 
	@${RM} ${OBJECTDIR}/testavr.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1 -g -DDEBUG  -gdwarf-2  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp="${DFP_DIR}/xc8"  -Wl,--gc-sections -O1 -ffunction-sections -fdata-sections -fshort-enums -fno-common -funsigned-char -funsigned-bitfields -Wall -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3     -MD -MP -MF "${OBJECTDIR}/testavr.o.d" -MT "${OBJECTDIR}/testavr.o.d" -MT ${OBJECTDIR}/testavr.o -o ${OBJECTDIR}/testavr.o testavr.c 
	
else
${OBJECTDIR}/testavr.o: testavr.c  .generated_files/flags/default/d4bce6127ed93a38bd14982921b2e1c8e5bdf4e3 .generated_files/flags/default/2ebadb7499da65fc4c278afdfab593bf9d1d26cd
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/testavr.o.d 
	@${RM} ${OBJECTDIR}/testavr.o 
...
${DISTDIR}/test_avr.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/test_avr.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -Wl,--gc-sections -O1 -ffunction-sections -fdata-sections -fshort-enums -fno-common -funsigned-char -funsigned-bitfields -Wall -gdwarf-3     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/test_avr.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  -o ${DISTDIR}/test_avr.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -Wl,--start-group  -Wl,-lm -Wl,--end-group 
